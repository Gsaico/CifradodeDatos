...
var friendconnect_serverVersion = "0.1-3f512359_37ceb115_dad844fd_24f6509b_5cf78f14.7";
...
fc1[fc].clear=function(){this.j={};fcda(this.e,0);this.$=this.v=0};fc1[fc].remove=function(a){return fcRb(this.j,a)?(delete this.j[a],this.v--,this.$++,this.e[fcB]>2*this.v&&this.K(),!0):!1};fc1[fc].K=function(){if(this.v!=this.e[fcB]){for(var a=0,b=0;a<this.e[fcB];){var c=this.e[a];fcRb(this.j,c)&&(this.e[b++]=c);a++}fcda(this.e,b)}if(this.v!=this.e[fcB]){for(var d={},b=a=0;a<this.e[fcB];)c=this.e[a],fcRb(d,c)||(this.e[b++]=c,d[c]=1),a++;fcda(this.e,b)}};
fc1[fc].get=function(a,b){return fcRb(this.j,a)?this.j[a]:b};fc1[fc].set=function(a,b){fcRb(this.j,a)||(this.v++,this.e[fcn](a),this.$++);this.j[a]=b};fc1[fc].ob=function(a){var b;a instanceof fc1?(b=a.r(),a=a.F()):(b=fcyb(a),a=fcxb(a));for(var c=0;c<b[fcB];c++)this.set(b[c],a[c])};fc1[fc].forEach=function(a,b){for(var c=this.r(),d=0;d<c[fcB];d++){var e=c[d],f=this.get(e);a[fcI](b,f,e,this)}};fc1[fc].clone=function(){return new fc1(this)};
...
"&"+this.hashData:"");1!=fc4.Lc||l||f||this.secureToken?f&&!e.sig&&(e.fcauth=f):e.sig||(c="get");f=this.ga();fcyc(f,d,c,e,a,b,this.rpcToken)};var fc7=function(){this.k={};this.T="http://"+fce[fcE].host;this.aa="default";this.gc=1;this.Qc=0;this.Nc="US";this.Oc="en";this.Pc=2147483647};fcV(fc7,fctc);fc7[fc].w=fcwc;fc7[fc].B=new fcvc;fc7[fc].gb=function(a){this.gc=a};fc7[fc].Ja=function(a){this.Lc=a};fc7[fc].Qa=function(a){return"gadget_"+a};fc7[fc].A=function(a){return this.k[this.Qa(a)]};
fc7[fc].N=function(a){return new this.w(a)};fc7[fc].pb=function(a){a.id=this.Lb();this.k[this.Qa(a.id)]=a};fc7[fc].ec=0;fc7[fc].Lb=function(){return this.ec++};var fcAc=function(){fc7[fcI](this);this.B=new fczc};fcV(fcAc,fc7);fcAc[fc].w=fc6;fcAc[fc].X=function(a){a[fcv](/^http[s]?:\/\//)||(a=fce[fcE][fcua][fcv](/^[^?#]+\//)[0]+a);this.T=a};fcAc[fc].J=function(a){var b=this.B.Pa(a);a.render(b)};var fczc=function(){this.Ab={}};fcV(fczc,fcuc);
...
fc9[fc].ic=function(){this.u();this.U()};fc5[fc].cb=function(a,b){var c=fc$(this.f),c=fc4.A(c),d=fcS(c.originalParams);b&&(d["view-params"]=d["view-params"]||{},d["view-params"]=b);d.locale=c[fcka];if(c.useLightBoxForCanvas)d.presentation=a,null!=fc4.lastLightboxDialog?fc4.u():fc4.jb(d);else if((c=c.Pb(a))&&fce[fcE][fcua]!=c)if("1"==fca[fcL][fcF]().embed)try{fcc.parent.location=c}catch(e){fcc.top.location=c}else fce[fcE].href=c};
...
fc5[fc].fb=function(a){var b=fce[fcs](this.f);b&&0<a&&fcl(b[fcG],a+"px");(b=fce[fcs](this.f+"_body"))&&0<a&&fcl(b[fcG],a+"px");if(b=fc$(this.f)){var c=fc4.A(b);c&&((b=fce[fcs](c.divId))&&0<a&&(c&&c[fcxa]&&c[fcxa]<a&&(a=c[fcxa],b[fcG].overflowY="auto"),fcl(b[fcG],a+"px")),!c.keepMax&&"canvas"==c.la()&&fc4.lastLightboxDialog&&fc4.lastLightboxDialog.reposition(),fcTb(c.chrome,"visibility","visible"))}};fc5[fc].setTitle=function(a){var b=fc$(this.f),b=fc4.A(b);(b=b.titleDivId)&&fck(fce[fcs](b),fca[fcL].escapeString(a))};
...
google.friendconnect.container.setServerBase('http://www-a-fc-opensocial.googleusercontent.com/ps/');google.friendconnect.container.setServerVersion('0.1-3f512359_37ceb115_dad844fd_24f6509b_5cf78f14.7');google.friendconnect.container.setApiVersion('0.8');
...
google.friendconnect.container.setDateStamp_('144aed9483c');